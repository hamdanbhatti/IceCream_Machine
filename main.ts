...
let is_Shop_Open: boolean = true; // Set this to false to test the shop closed scenario

console.log(chalk.bold.bgRgb(187, 230, 78)("\n\t\t Welcome to our IceCream Shop \n"));

const order = async (time: number, work: () => void): Promise<void> => {
     if (is_Shop_Open) {
